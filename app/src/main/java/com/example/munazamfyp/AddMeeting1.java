...
public class AddMeeting1 extends AppCompatActivity {
    ...
    public void openedit(View vie) {
        ...
        View promptsView = li.inflate(R.layout.activity_add_meeting1, null);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (name.length() >= 3 && pass1.length() >= 8) {
                                    ...
                                    Toast.makeText(AddMeeting1.this, "Incorrect Length of Password or Username", Toast.LENGTH_SHORT).show();
                                }
    ...
    public void onClick(View v) {
        androidx.appcompat.app.AlertDialog.Builder mBuilder = new androidx.appcompat.app.AlertDialog.Builder(AddMeeting1.this);
        View mView = getLayoutInflater().inflate(R.layout.dialog_spinner, null);
        mBuilder.setTitle("Choose Classroom");
        final Spinner mSpinner = (Spinner) mView.findViewById(R.id.spinner3);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AddMeeting1.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.CS));
    ...
    public void onClick1(View v) {
        ...
        mBuilder.setTitle("Choose Classroom");
        final Spinner mSpinner = (Spinner) mView.findViewById(R.id.spinner3);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AddMeeting1.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.EE));
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mSpinner.setAdapter(adapter);
    ...
    public void onClick2(View v) {
        ...
        mBuilder.setTitle("Choose Classroom");
        final Spinner mSpinner = (Spinner) mView.findViewById(R.id.spinner3);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AddMeeting1.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.SC));
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mSpinner.setAdapter(adapter);
